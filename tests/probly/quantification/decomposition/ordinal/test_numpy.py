...
def test_standalone_measure_functions_match_decomposition() -> None:
    ...
    np.testing.assert_allclose(ordinal_expected_conditional_variance(sample), d_ord_var.aleatoric)
    ...
    np.testing.assert_allclose(labelwise_expected_conditional_variance(sample), d_lw_var.aleatoric)
...
def test_gaussian_standalone_functions_match_decomposition() -> None:
    sample = _gaussian_sample()
    d = SecondOrderVarianceDecomposition(sample)
    np.testing.assert_allclose(expected_conditional_variance(sample), d.aleatoric)
    np.testing.assert_allclose(variance_of_conditional_mean(sample), d.epistemic)
