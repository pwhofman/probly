"""Tests for sample-based jax uncertainty measures."""
...
class TestSampleMeasureArray:
    ...
    def test_mean_squared_distance_array(self) -> None:
        ...
        probs = jnp.array([[[0.6, 0.3, 0.1]], [[0.1, 0.6, 0.3]]])
        dist = JaxProbabilityCategoricalDistribution(array=probs)
        sample = JaxCategoricalDistributionSample(array=dist, sample_axis=0)
