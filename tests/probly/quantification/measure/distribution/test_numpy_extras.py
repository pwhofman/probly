...
class TestRawArrayDirichletPaths:
    ...
    def test_entropy_with_raw_alphas(self) -> None:
        ...
        wrapper_result = numpy_dirichlet_entropy(ArrayDirichletDistribution(alphas=alphas))
    ...
    def test_conditional_entropy_with_raw_alphas(self) -> None:
        ...
        wrapper_result = numpy_dirichlet_conditional_entropy(ArrayDirichletDistribution(alphas=alphas))
    ...
    def test_mutual_information_with_raw_alphas(self) -> None:
        ...
        wrapper_result = numpy_dirichlet_mutual_information(ArrayDirichletDistribution(alphas=alphas))
...
class TestRawArrayGaussianPaths:
    ...
    def test_entropy_with_raw_var(self) -> None:
        ...
        wrapper_result = numpy_gaussian_entropy(ArrayGaussianDistribution(mean=np.zeros_like(var), var=var))
