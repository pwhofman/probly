...
class TestNetworkArchitectures:
    ...
    def test_linear_convolutional_linear_network(self, torch_conv_linear_model: nn.Sequential) -> None:
        """Tests if a sequential model appends an evidential classification layer correctly.
        ...
        Parameters:
            torch_conv_linear_model: The torch model to be tested, specified as a sequential model.
