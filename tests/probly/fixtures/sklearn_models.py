...
@pytest.fixture
def sklearn_linear_regression(sklearn_random_state: int) -> BaseEstimator:
    """Return a small regression model with 2 input features."""
    model = LinearRegression(random_state=sklearn_random_state)
    return model
