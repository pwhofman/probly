...
def test_numpy_decomposition_epistemic_matches_vacuity() -> None:
...
def test_numpy_decomposition_epistemic_known_values() -> None:
    distribution = _numpy_dirichlet()
...
def test_numpy_decomposition_components_only_epistemic() -> None:
    decomposition = EvidentialClassificationDecomposition(_numpy_dirichlet())
