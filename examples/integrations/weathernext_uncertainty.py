...
def ensemble_fn(seeds, inputs, targets_template, forcings):
    ...
    for chunk in rollout.chunked_prediction_generator_multiple_runs(
        ...
        # Block on the chunk and move it to host memory: keeping device-backed chunks makes the later
        # xarray combine dispatch a storm of tiny GPU ops that is orders of magnitude slower.
