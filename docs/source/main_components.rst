...
- **Probabilistic Layers**: Drop-in replacements for standard layers (Linear, Conv2D, etc.) that incorporate stochasticity, enabling Bayesian inference within your models.

- **Utility Functions**: Helper functions for extracting mean and variance from model outputs, computing prediction intervals, and formatting probabilistic predictions for downstream tasks.
