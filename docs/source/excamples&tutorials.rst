...
def **init**(self, input_dim=28*28, hidden_dim=128, num_classes=10):
super().**init**()
...
def **init**(self, full_ensemble: Ensemble, indices):
super().**init**()
