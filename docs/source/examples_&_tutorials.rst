...
These are short, focused example pages (generated by Sphinx-Gallery) that are relevant
to the topics on this page.
...
.. raw:: html
    ...
    <ul class="simple">
      <li><a class="reference internal" href="auto_examples/plot_gallery_smoke_test.html">Sphinx-Gallery smoke test</a></li>
      <li><a class="reference internal" href="auto_examples/plot_samples_with_array_sample.html">Working with samples (<cite>ArraySample</cite>)</a></li>
      <li><a class="reference internal" href="auto_examples/plot_create_sample_dispatch.html">Automatic sample construction (dispatcher)</a></li>
      <li><a class="reference internal" href="auto_examples/plot_using_predict_protocol.html">Using the generic predict()</a></li>
    </ul>
