...
.. "auto_examples/examples/plot_samples_with_array_sample.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_examples_plot_samples_with_array_sample.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_examples_plot_samples_with_array_sample.py:
...
.. image-sg:: /auto_examples/examples/images/sphx_glr_plot_samples_with_array_sample_001.png
   :alt: Instance 0: mean ± std across stochastic passes
   :srcset: /auto_examples/examples/images/sphx_glr_plot_samples_with_array_sample_001.png
...
.. _sphx_glr_download_auto_examples_examples_plot_samples_with_array_sample.py:
