...
.. "auto_examples/examples/plot_using_predict_protocol.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_auto_examples_examples_plot_using_predict_protocol.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_auto_examples_examples_plot_using_predict_protocol.py:
...
.. image-sg:: /auto_examples/examples/images/sphx_glr_plot_using_predict_protocol_001.png
   :alt: Threshold predictor output
   :srcset: /auto_examples/examples/images/sphx_glr_plot_using_predict_protocol_001.png
...
.. _sphx_glr_download_auto_examples_examples_plot_using_predict_protocol.py:
