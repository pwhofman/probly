...
This part of the documentation has four entry points. :ref:`contributing_guidelines`
...
Finally, :ref:`jax_representations` documents the operator and validation
machinery behind the JAX representation types.
