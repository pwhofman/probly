...
from probly.lazy_types import JAX_ARRAY, SKLEARN_ARRAY, TORCH_TENSOR
...
@create_sample.delayed_register(SKLEARN_ARRAY)
def _(_: type) -> None:
    from . import sklearn_sample as sklearn_sample  # noqa: PLC0414, PLC0415
