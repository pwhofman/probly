"""Shared Bayesian ensemble transformation implementation."""
...
@runtime_checkable
class BayesianEnsemblePredictor[**In, Out](EnsemblePredictor[In, Out], Protocol):
    """A predictor that applies Bayesian-layer transformations to ensemble members."""
