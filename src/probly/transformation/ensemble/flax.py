...
def _random_reset(obj: nnx.Module, key: jax.random.PRNGKey, shape: jnp.ndarray) -> tuple[nnx.Module, dict]:
    """Reset params for flax module."""
    params = nnx.init(key, shape)
    return obj, params


def generate_flax_ensemble(obj: nnx.Module, num_members: int, reset_params: bool) -> list[tuple[nnx.Module, dict]]:
