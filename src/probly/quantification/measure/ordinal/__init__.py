...
from .numpy import (  # noqa: F401  (registers numpy implementations)
    ...
    numpy_categorical_sample_labelwise_conditional_variance,
    ...
    numpy_categorical_sample_labelwise_mutual_information_variance,
    ...
    numpy_categorical_sample_ordinal_conditional_variance,
    ...
    numpy_categorical_sample_ordinal_mutual_information_variance,
