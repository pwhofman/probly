...
from probly.representation.distribution.numpy_categorical import NumpyCategoricalDistributionSample


@mean_squared_distance_to_scaled_one_hot.register(NumpyCategoricalDistributionSample)
def numpy_mean_squared_distance_to_scaled_one_hot(
    sample: NumpyCategoricalDistributionSample, scale: float | None = None
) -> np.ndarray:
...
@total_logit_sample_variance.register(NumpyCategoricalDistributionSample)
def numpy_total_logit_sample_variance(sample: NumpyCategoricalDistributionSample) -> np.ndarray:
