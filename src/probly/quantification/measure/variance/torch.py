...
def torch_gaussian_sample_conditional_variance(sample: TorchGaussianDistributionSample) -> torch.Tensor:
...
def torch_gaussian_sample_mutual_information(sample: TorchGaussianDistributionSample) -> torch.Tensor:
...
def torch_sample_variance_of_expected_predictive_distribution(sample: TorchSample) -> torch.Tensor:
...
def torch_sample_conditional_variance(sample: TorchSample) -> torch.Tensor:
...
def torch_sample_mutual_information(sample: TorchSample) -> torch.Tensor:
