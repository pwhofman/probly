...
JAX_CATEGORICAL_DISTRIBUTION = "probly.representation.distribution.jax_categorical.JaxCategoricalDistribution"
JAX_GAUSSIAN_DISTRIBUTION = "probly.representation.distribution.jax_gaussian.JaxGaussianDistribution"
