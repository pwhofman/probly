...
### Hauptdokumentation
- **[Benutzerhandbuch](docs/data_generation_guide.md)** - Ausführliche Anleitung mit Beispielen
- **[API Referenz](docs/api_reference.md)** - Vollständige API-Dokumentation
- **[Multi-Framework Guide](docs/multi_framework_guide.md)** - Framework-spezifische Details
...
**Eigenschaften:**
- UTF-8 Encoding
- Framework-kompatibel (alle Frameworks können die gleichen JSON-Dateien lesen)
...
| `device` | str | `"cpu"` | Device: `"cpu"`, `"cuda"`, `"gpu"`, `"tpu"` |
| `batch_size` | int | `64` | Batch-Größe für Inferenz |
| `output_mode` | str | `"auto"` | `"auto"`, `"logits"` oder `"probs"` |
| `output_transform` | Callable\|None | `None` | Custom Transform-Funktion |
| `input_getter` | Callable\|None | `None` | Custom Input-Extraktion |
...
### Dokumentation
- **[Data Generation Guide](docs/data_generation_guide.md)** - Ausführliches Tutorial
...
|-----------|---------|--------|-------|
| PyTorch | >= 1.8.0 | Full Support | Empfohlen |
| TensorFlow | >= 2.4.0 | Full Support | tf.data.Dataset |
| JAX | >= 0.3.0 | Full Support | jnp.ndarray |
...
**Entwickelt von**: ProblyPros
**Maintainer**: Zhiyi Fan
